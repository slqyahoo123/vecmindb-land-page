...
const translations = {
    'zh': {
        ...
        'qs-dash-tip-desc': '一旦 Docker 或二进制启动成功，直接在浏览器中打开内置控制台，直观观察记忆蒸馏与集群拓扑。',
    ...
    'en': {
        ...
        'qs-dash-tip-desc': 'Once Docker or the native binary is running, open the built-in dashboard in your browser to monitor memory distillation and cluster status.',
